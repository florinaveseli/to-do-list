    ...
    public static void main (String [] args) {
        ...
        while (process) {
            ...
            if (input.equals("1")) {
                ...
                int minutes = new Integer(JOptionPane.showInputDialog("Minutes of appointment:")).intValue();
            ...
            if (input.equals("2")){
                ...
                int minutess = new Integer(JOptionPane.showInputDialog("Minutes of appointment:")).intValue();
                
                int idd = dayy+monthh+yearr+hourr+minutess;
                 
               appointments.delete(new Key_ap(idd));
               justDeletedAppointments++;
            ...
            if (input.equals("3")){
             ...
             if (input.equals("4")){
                ...
                int minutesss = new Integer(JOptionPane.showInputDialog("Minutes of appointment:")).intValue();
               ...
               JOptionPane.showMessageDialog(null," This appointment is finished \n "+app.getName()+" " +app.getDate()+" "+app.getHour()+"\n Number of deleted appointment " +deletedAppointments );
                ...
                { 
                    ...
                    if (app1 != null){ currentAppointments ++;
                      ...
                      JOptionPane.showMessageDialog(null,"Current appointment \n Name: "+app1.getName()+"  ID of appointment: "+i+" -- Data: "+app1.getDate()+
