...
public class Database_ap
{ private Record_ap [] base;   // the collection of records
    ...
    public Database_ap(int initial_size)
    { if ( initial_size > 0 )
    { base = new Record_ap[initial_size]; }
    else { base = new Record_ap[1]; }
    }
    ...
    private int findLocation(Key_ap k)
    ...
    public Record_ap find(Key_ap k)
    { Record_ap answer = null;
    ...
    public boolean insert(Record_ap r)
    { boolean success = false;
        ...
        { // find an empty element in  base  for insertion of  r:
            ...
            { base[i] = r; }
                ...
                Record_ap[] temp = new Record_ap[base.length * 2];
    ...
    public boolean delete(Key_ap k)
